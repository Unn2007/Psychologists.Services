...
export const FiltersForm = () => {
  ...
  return (
    <form className={css.form}>
      ...
      >
        <option className={css.option} value="Show all">
          Show all
        </option>
        <option className={css.option} value="A to Z">
          A to Z
        </option>
        <option className={css.option} value="Z to A">
          Z to A
        </option>
        <option className={css.option} value="Less than 10$">
          Less than 10$
        </option>
        <option className={css.option} value="Greater than 10$">
          Greater than 10$
        </option>
